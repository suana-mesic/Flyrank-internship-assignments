...
Before building anything, this assignment settles the single most important question: what does my portfolio prove, to whom, and what one action should it drive? The proof statement below names one primary claim, one specific person who could hire me, and one action.
...
A CV can list C# and SQL — it cannot show that I know why Clean Architecture exists or that I can apply it to a real problem. Owning a portfolio fixes that: it lets the code and the decisions behind it speak, instead of a list of keywords.
